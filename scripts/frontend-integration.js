 ...
 * This file demonstrates how to integrate Nftkite with a web frontend
 */

// For React/Vue/Angular applications
export class NftkiteClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NftkiteClient(provider, contractAddress);
